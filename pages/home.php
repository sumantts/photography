...
include('studio/assets/php/homeCtrl.php');
?>
  <body>
    <!-- ===============================================-->
    <!--    Main Content-->
      ...
      <section class="py-4 pt-md-0 pb-8 pb-sm-11 mt-lg-n8">
        <div class="container px-md-5">
          ...
          <div class="row mt-md-n6">
            <div class="col-2 d-none d-lg-block mt-auto"><img class="img-fluid" src="studio/assets/images/home_page/<?=$hom_bottom_left_img_old?>" alt="" /></div>
            ...
            <div class="col-lg-7 position-relative">
              <div class="position-relative overflow-hidden overflow-md-visible"><img class="img-fluid" src="studio/assets/images/home_page/<?=$hom_middle_img_old?>" alt="" />
              ...
              <div class="position-absolute bottom-n100 col-11 mt-6 d-none d-md-block">
                <p class="fs-2 lh-1 text-400"><?=$hom_title?></p>
                <p class="text-300"><?=$hom_description?></p>
              </div>
            ...
            <div class="col-2 d-none d-lg-block mb-auto"><img class="img-fluid" src="studio/assets/images/home_page/<?=$hom_top_right_img_old?>" alt="" /></div>
          </div>
        </div>
        <!-- end of .container-->
      </section>
